...
# ------------------------------------------------------------------------------
# THE KITCHEN SINK: MASTER VISUALIZATION SUITE (v5 - org.Hs.eg.db Mapping)
# ------------------------------------------------------------------------------
...
suppressPackageStartupMessages({
    ...
    library(stringr)
    library(data.table)
    library(org.Hs.eg.db) # Standardized ID Mapping
})
...
ht <- Heatmap(gsva_res[top_pathways, ], name="GSVA", column_title="Pathway Activity", 
