...
# ================= CONFIGURATION =================
# 1. Your OAuth Token (Copied from your previous file)
# TOKEN=PLEASE REQUEST TOKEN FROM ME "go2432@wayne.edu"

# 2. The Folder ID (CORRECTED)
FOLDER_ID="1Zw1uNdYTCSuUaKc9fVS-1WzpTQKus2K6"
# =================================================

# Create RAW directory if it doesn't exist and move into it
mkdir -p RAW
cd RAW
...
# Use the shell variable for token and folder_id
token = '$TOKEN'
folder_id = '$FOLDER_ID'
